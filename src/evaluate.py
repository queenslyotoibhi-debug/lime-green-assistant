...
from rag_answer import answer_question, find_source_numbers
...
def source_numbers(text):
    # Same parser the application uses, so validation cannot pass on a citation
    # shape the application would drop.
    return find_source_numbers(text)
